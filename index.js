...
//   if (!username) {
//     res.render("signupError", { error: "Name" });
//   }
//   if (!email) {
...
//   if (validationResult.error != null) {
//     console.log(validationResult.error);
//     res.render("signupError", { error: `${validationResult.error.message}`, authenticated: req.session.authenticated });
//     return;
//   }

//   const user = await userCollection.findOne({ email: email });
//   if (user) {
//     res.render("signupError", { error: "Email already exists", authenticated: req.session.authenticated });
//     return;
//   }
...
app.post("/submitUser", async (req, res) => {
  ...
  if (!username || !email || !password) {
    let missing = !username ? "Name" : !email ? "Email" : "Password";
